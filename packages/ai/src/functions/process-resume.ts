...
const PROCESS_RESUME_SYSTEM_MESSAGE =
  ...
  "adapt their resumes to specific positions, and identify gaps in their qualifications. You provide " +
  "comprehensive, actionable advice that helps candidates make informed career decisions.";
...
export async function processResume(
  ...
  try {
    const response = await client.post("/chat/completions", {
      ...
      temperature: 0.4, // Balanced temperature for all three tasks
    });
