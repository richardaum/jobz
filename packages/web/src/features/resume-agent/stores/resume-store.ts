...
interface ResumeStore {
  ...
  updateOutputs: (data: { adaptedResume: string; gaps: string; matchResult: MatchResult }) => void;
  ...
  persist(
    (set, get) => {
      return {
        ...
        // Outputs
        updateOutputs: (data: { adaptedResume: string; gaps: string; matchResult: MatchResult }) =>
          set({
